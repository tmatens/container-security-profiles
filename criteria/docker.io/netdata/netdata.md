...
## Derivation: bisection (observer=bisection)
...
**bisection**, run against netdata deployed as a **host monitor**: `pid: host`,
...
`duration_seconds` records the approximate total bisection wall-clock; bisection
is exempt from the observation-window floor (ADR-017 §8).

## Dimension & pass criteria

### capabilities (CL-0006 / CL-0011)
- **Bisection result** (drop each of the 7 originally granted, restart, verify):
